...
'      On Error Resume Next
    ...
    Sub GetDataFromDB
      ...
      strSQL = "SELECT * FROM ITAMData.dbo.acReportOnRfC WHERE [DTCreation] IS NOT NULL and [SerialNo] = '" & sSerialNumber & "' " 
      objRs.Open strSQL, objConn
      If Not objRs.EOF Then
        strRfCChangeRef = objRs("ChangeRef")
        strRfCDate = SQLDate(objRs("DTCreation"))
      End If
...
'          sDepartment = ""
    ...
    Sub DisplayData(bEditParameter)
      ...
      If strRfCChangeRef <> "" Then
				fSpecialStatus.InnerHTML = "<span style=""color:red"">" & strRfCChangeRef & " (" & strRfCDate & ")" & "</span>"
      End If
