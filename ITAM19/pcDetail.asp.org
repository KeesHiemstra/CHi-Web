...
strColor = ""
If DateDiff("d", objRs("DTLastScan"), Now()) > 10 Then
	strColor = " style=""color:red"""
End If
Response.Write "<tr><td>Radia last connect date</td><td" & strColor & ">" & CISODateTime(objRs("DTLastScan")) & "</td></tr>"
...
If objRs("ScannerDesc") <> "" Then
	Response.Write "<tr style=""color:red""><td>Radia status</td><td>" & objRs("ScannerDesc") & "</td></tr>"
End If
  ...
  strSQL = "SELECT * FROM ITAMNetwork.dbo.avComputer WHERE [ComputerName] = '" & strComputerName & "'"
	...
	On Error Resume Next
	    ...
	    intID = objRs("ComputerID")
			...
			strColor = ""
			If Left(objRs("Version"), 3) <> "11." Then
				strColor = " style=""color:red"""
			End If
